...
public class UserVideosAdapter extends RecyclerView.Adapter<UserVideosAdapter.CustomViewHolder> {

    Context context;
    List<UserVideo> dataList;
    OnShareClickListner onShareClickListner;

    public UserVideosAdapter(Context context, List<UserVideo> dataList, OnShareClickListner onShareClickListner) {
    ...
    public void onBindViewHolder(CustomViewHolder holder, int position) {
        UserVideo response = dataList.get(position);
        Glide.with(context).load(Utils.getImage()).placeholder(R.drawable.person).into(holder.usr_image);
        holder.usr_name.setText(Utils.getName());
